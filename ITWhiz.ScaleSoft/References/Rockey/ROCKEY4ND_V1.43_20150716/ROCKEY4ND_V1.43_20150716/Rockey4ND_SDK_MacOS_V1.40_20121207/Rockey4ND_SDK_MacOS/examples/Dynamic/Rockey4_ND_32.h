...
#define  ERR_NO_ROCKEY			3		// No rockey dongle
#define  ERR_INVALID_PASSWORD		4		// Found rockey dongle, but base password is wrong
#define  ERR_INVALID_PASSWORD_OR_ID 	5		// Wrong password or rockey HID
#define  ERR_SETID			6               // Set rockey HID wrong
...
#ifdef USE_DY_LIB
typedef WORD (*TRockey)(WORD function, WORD* handle, DWORD* lp1,  DWORD* lp2, WORD* p1, WORD* p2, WORD* p3, WORD* p4, BYTE* buffer);
#else

EXTERN_C  WORD Rockey(WORD function, WORD* handle, DWORD* lp1,  DWORD* lp2, WORD* p1, WORD* p2, WORD* p3, WORD* p4, BYTE* buffer);
#endif 
