import java.lang.*;
//import Feitian.Rockey.Ry4S;

public class Ry4ND_Sample
{
	public static void main(String[] args)
	{
		...
		System.out.println("Find Rockey:"+lp1[0]);
		...
		while(retval==rockey.ERR_SUCCESS)
		{
			...
			i++;
			System.out.println("Find another Rockey:"+lp1[0]);
		}
		...
		for(int j=0;j<i;j++)
		{
			...
			System.out.println();
			System.out.println("Current Rockey handle is: "+handle[0]);
			p1[0]=3;
			p2[0]=6;
...
//			buffer[3]=78;	buffer[4]=90;	buffer[5]=20;
			...
			retval = rockey.Rockey(rockey.RY_WRITE,handle,lp1,lp2,p1,p2,p3,p4,buffer);//Ð´Ëø
			if(retval!=rockey.ERR_SUCCESS)
			{
			...
			retval = rockey.Rockey(rockey.RY_READ,handle,lp1,lp2,p1,p2,p3,p4,buffer);//¶ÁËø
			if(retval!=rockey.ERR_SUCCESS)
			{
