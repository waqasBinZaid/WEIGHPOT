...
namespace IWeigh
{
    public partial class FrmWeighmentEntry : Form
    {
        ...
        public FrmWeighmentEntry(Globals.WEIGHMENT_ENTRY weighmentEntry)
        {
            InitializeComponent();
        ...
        public FrmWeighmentEntry(Weighment WeighmentEntry)
        {
            InitializeComponent();
            InitParty();
            InitProducts();
        ...
        private bool ValidateWeighmentDetail()
        {
            ...
            if (string.IsNullOrEmpty(this.cboParty.Text))
            {
                this.ep.SetError(this.cboParty, "Required");
                return false;
            }

            if (this.cmbItem.Text.Trim().Length == 0)
            {
                this.ep.SetError(this.cmbItem, "Product Is Required");
                return false;
            }
        ...
        private bool ValidateWeighment()
        {
            ...
            if (_weighmentEntry == Globals.WEIGHMENT_ENTRY.FIRST)
            {
                ...
                //MessageBox.Show("s-veh : " + this.txtVehicleNo.Text.Trim());
                //MessageBox.Show("vno : " +vno);
                int cnt = 0;
            ...
            {
                //if (selectedWeighments.SecondType.Trim().Length > 0)
                //{
                //    this.ep.SetError(this.txtSerialNo, "Record already processed.. ");
                //    return false;
                //}
            }
        ...
        private void SetUIMode()
        {
            if (_weighmentEntry == Globals.WEIGHMENT_ENTRY.FIRST)
            {
                ...
                this.txtBiltyNo.TabIndex = 3;
                this.txtSealNo.TabIndex = 4;
            ...
            try
            {
                if (!spIndicator.IsOpen)
                {
                    ...
                    if (!AllowManualWeighment)
                    {
                        ...
                        //string portname = spIndicator.PortName;
                        //string baudrate = spIndicator.BaudRate.ToString();
                        //string parity = spIndicator.Parity.ToString();
                        //string databit = spIndicator.DataBits.ToString();
                        //MessageBox.Show("PortName:"+" "+portname+ ", " + "BaudRate:" + " " + baudrate + ", " + "Parity:" + " " + parity + ", " + "DataBit:" + " " + databit+","+"StringLength"+FilterByteSize+",Control Character:"+ControlCharacter+",Filter Direction:"+FilterDirection+",Start Index:"+FilteredStartIndex+",ReadDelay:"+ReadDelay);
        ...
        private void CmdOK_Click(object sender, EventArgs e)
        {
             if (ValidateWeighment())
            {
                ...
                _WeighmentEntry.ContainerNo = this.txtContainerNo.Text;
                _WeighmentEntry.BiltyNo = this.txtBiltyNo.Text;
                _WeighmentEntry.SealNo = this.txtSealNo.Text;
                _WeighmentEntry.DriverName = this.txtDriverName.Text;
                _WeighmentEntry.NoOfBags = this.txtNoOfBags.Text;
                _WeighmentEntry.Remark = txtRemark.Text;
                _WeighmentEntry.RevisionNumber = 2;
                _WeighmentEntry.Id = wId;
              //  _WeighmentEntry.MWeight = this.txtWeightIndicator.ReadOnly;
              ...
              //  _WeighmentEntry.FirstWeight =EncryiptionHelper.Encrypt(fwght.ToString(),true);
                _WeighmentEntry.FirstDateTime = fdatetime;
                _WeighmentEntry.FirstType = ftype;
                _WeighmentEntry.SecondWeight = swght;
              //  _WeighmentEntry.SecondWeight =EncryiptionHelper.Encrypt(swght.ToString(),true);
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            if (ValidateWeighmentDetail())
            {
                ...
                _WeighmentEntry.Weight =Convert.ToDouble( this.txtTotalNetWeight.Text);
                ...
                if (txtSerialNo.Text != "" && txtSerialNo.Text.Trim().Length > 9)
                {
                    ...
                    if (dupsecondweight <= 0 && dupfirstweight > 0)
                    {
                        ...
                        else
                        {
                            ...
                            this.txtParty.Text = selectedWeighment.ProductName;
                            this.txtProduct.Enabled = true;
                        }
        ...
        private void txtNoOfBags_TextChanged(object sender, EventArgs e)
        {
