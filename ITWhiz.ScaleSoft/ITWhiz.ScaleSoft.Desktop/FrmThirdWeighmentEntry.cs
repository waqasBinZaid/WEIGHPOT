...
namespace IWeigh
{
    public partial class FrmThirdWeighmentEntry : Form
    {
        ...
        public FrmThirdWeighmentEntry(Globals.WEIGHMENT_ENTRY weighmentEntry)
        {
            InitializeComponent();
        ...
        public FrmThirdWeighmentEntry(Weighment WeighmentEntry)
        {
            InitializeComponent();
        ...
        private void AddWeighmentEntry()
        {
            ...
            if (txtManualWeight.Visible==true)
            {
                if (datacontrol == 0)
                {
                    ...
                    item.SubItems.Add(this.txtManualWeight.Text);
        ...
        private bool ValidateWeighmentDetail()
        {
            ...
            if (this.txtManualWeight.Text.Trim().Length == 0)
            {
                this.ep.SetError(this.txtManualWeight, "Zero weight cannot be saved.");
                return false;
            }

            if (!this.txtManualWeight.Text.IsNumeric())
            {
                this.ep.SetError(this.txtManualWeight, "Only numeric value is allowed");
                return false;
            }
        ...
        private void SetUIMode()
        {
            if (_weighmentEntry == Globals.WEIGHMENT_ENTRY.FIRST)
            {
                ...
                this.btnManualWeight.Visible = false;
       ...
       // start..party ,product dropdown, textbox configuration
          ...
          // end .. party ,product dropdown ,textbox configuration
                ...
                this.CmdOK.Enabled = false;
                this.btnManualWeight.Visible = true;
        ...
        private void btnWeighmentEntry_Click(object sender, EventArgs e)
        {
            ...
            if (txtManualWeight.Visible == false)
            ...
            if (txtManualWeight.Visible == true)
                if (ValidateWeighmentDetail())
                {
                    ...
                    ManualWeightEntry();
                    AddWeighmentEntry();
                    lblManualWeight.Visible = false;
                    txtManualWeight.Visible = false;
                }
        ...
        private void ManualWeightEntry() {
            if (ValidateWeighmentDetail())
            {
                //start.. party product add with respect to dropdown or textbox
                ...
                _WeighmentEntry.FirstWeight = Convert.ToDouble(this.txtManualWeight.Text);
                _WeighmentEntry.From = this.txtFrom.Text;
                _WeighmentEntry.To = this.txtTo.Text;
                _WeighmentEntry.ReceivedAmount = 0;
    ...
    public class ReusableContent1 : HttpContent
    {
        private readonly HttpContent _innerContent;

        public ReusableContent1(HttpContent innerContent)
        {
